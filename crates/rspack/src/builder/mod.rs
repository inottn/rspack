...
use rspack_core::{
  ...
  JavascriptParserImportMeta, JavascriptParserOptions, JavascriptParserOrder, JavascriptParserUrl,
  ...
  StatsOptions, TrustedTypes, UnsafeCachePredicate, UsedExportsOption, WasmLoading,
  WasmLoadingType,
    ...
    if !parser.contains_key("javascript") {
      parser.insert(
        ...
        ParserOptions::Javascript(JavascriptParserOptions {
          ...
          import_meta: Some(JavascriptParserImportMeta::Enable),
